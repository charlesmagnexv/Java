...
public class Ex15
{
	public static void main(String[] args) {
		...
		int tamanhoVetorS=(int)(Math.random()*10)+1;
		int tamanhoVetorT=(int)(Math.random()*15)+1;
	    int vetorS[]=new int[tamanhoVetorS],vetorT[]=new int[tamanhoVetorT],vetorU[]=new int[vetorS.length+vetorT.length],j=0;
